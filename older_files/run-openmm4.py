...
for i in range(args.idxstart,args.idxend):
  ...
  fileoutpdb=args.path+'/iter'+str(args.iter)+'_out'+str(i)+'.pdb'
  argsrestart=args.path+'/iter'+str(args.iter)+'_restart'+str(i)+'.npz'
  savedcdfile=args.path+'/iter'+str(args.iter)+'_traj'+str(i)+'.dcd'
  savedcdfileextend=args.path+'/iter'+str(args.iter)+'_traj'+str(i)+'extend.dcd'
