...
# installed.
TK_PREFIX='/gpfs/alpine/proj-shared/bip191/ExTASY/.conda/envs/vampnet'

# Top-level directory in which Tk's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='/gpfs/alpine/proj-shared/bip191/ExTASY/.conda/envs/vampnet'
...
# build directory.
TK_BUILD_LIB_SPEC='-L/home/conda/feedstock_root/build_artifacts/tk_1574438165484/work/tk8.6.10/unix -ltk8.6'

# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-L/gpfs/alpine/proj-shared/bip191/ExTASY/.conda/envs/vampnet/lib -ltk8.6'

# String to pass to the compiler so that an extension can
# find installed Tk headers.
TK_INCLUDE_SPEC='-I/gpfs/alpine/proj-shared/bip191/ExTASY/.conda/envs/vampnet/include'
...
# compiled.
TK_SRC_DIR='/home/conda/feedstock_root/build_artifacts/tk_1574438165484/work/tk8.6.10'
...
# build directory.
TK_BUILD_STUB_LIB_SPEC='-L/home/conda/feedstock_root/build_artifacts/tk_1574438165484/work/tk8.6.10/unix -ltkstub8.6'

# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-L/gpfs/alpine/proj-shared/bip191/ExTASY/.conda/envs/vampnet/lib -ltkstub8.6'

# Path to the Tk stub library in the build directory.
TK_BUILD_STUB_LIB_PATH='/home/conda/feedstock_root/build_artifacts/tk_1574438165484/work/tk8.6.10/unix/libtkstub8.6.a'

# Path to the Tk stub library in the install directory.
TK_STUB_LIB_PATH='/gpfs/alpine/proj-shared/bip191/ExTASY/.conda/envs/vampnet/lib/libtkstub8.6.a'
